...
// swagger:model ExpressRouteCircuitPeeringListResult
type ExpressRouteCircuitPeeringListResult struct {
	...
	Value []*ExpressRouteCircuitPeering `json:"value"`
}

// Validate validates this express route circuit peering list result
func (m *ExpressRouteCircuitPeeringListResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ExpressRouteCircuitPeeringListResult) validateValue(formats strfmt.Registry) error {
