...
// Validate validates this route list result
func (m *RouteListResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RouteListResult) validateValue(formats strfmt.Registry) error {
