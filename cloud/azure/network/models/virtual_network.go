...
func (m *VirtualNetwork) UnmarshalJSON(raw []byte) error {
	var data struct {
		Etag string `json:"etag,omitempty"`
...
func (m VirtualNetwork) MarshalJSON() ([]byte, error) {
	var _parts [][]byte
	var data struct {
		Etag string `json:"etag,omitempty"`
...
func (m *VirtualNetwork) validateProperties(formats strfmt.Registry) error {
