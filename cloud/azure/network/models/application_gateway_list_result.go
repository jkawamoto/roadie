...
// swagger:model ApplicationGatewayListResult
...
// Validate validates this application gateway list result
func (m *ApplicationGatewayListResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApplicationGatewayListResult) validateValue(formats strfmt.Registry) error {
