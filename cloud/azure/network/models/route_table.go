...
func (m *RouteTable) UnmarshalJSON(raw []byte) error {
	var data struct {
		Etag string `json:"etag,omitempty"`
...
func (m RouteTable) MarshalJSON() ([]byte, error) {
	var _parts [][]byte
	var data struct {
		Etag string `json:"etag,omitempty"`
...
func (m *RouteTable) validateProperties(formats strfmt.Registry) error {
