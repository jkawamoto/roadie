...
func (m *SecurityRule) UnmarshalJSON(raw []byte) error {
	var data struct {
		Etag string `json:"etag,omitempty"`
...
func (m SecurityRule) MarshalJSON() ([]byte, error) {
	var _parts [][]byte
	var data struct {
		Etag string `json:"etag,omitempty"`
...
func (m *SecurityRule) validateProperties(formats strfmt.Registry) error {
