...
// swagger:model UsagesListResult
...
// Validate validates this usages list result
func (m *UsagesListResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *UsagesListResult) validateValue(formats strfmt.Registry) error {
