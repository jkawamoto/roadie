...
// swagger:model SubnetListResult
...
// Validate validates this subnet list result
func (m *SubnetListResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SubnetListResult) validateValue(formats strfmt.Registry) error {
