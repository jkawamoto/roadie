...
// AccountListNodeAgentSkusResult The result of listing the supported node agent SKUs.
// swagger:model AccountListNodeAgentSkusResult
...
func (m *AccountListNodeAgentSkusResult) validateValue(formats strfmt.Registry) error {
