...
// NewJobUpdateParams creates a new JobUpdateParams object
...
// NewJobUpdateParamsWithTimeout creates a new JobUpdateParams object
...
// NewJobUpdateParamsWithContext creates a new JobUpdateParams object
...
/*JobUpdateParams contains all the parameters to send to the API endpoint
for the job update operation typically these are written to a http.Request
*/
...
func (o *JobUpdateParams) WithJobUpdateParameter(jobUpdateParameter *models.JobUpdateParameter) *JobUpdateParams {
	o.SetJobUpdateParameter(jobUpdateParameter)
	return o
}
...
func (o *JobUpdateParams) SetJobUpdateParameter(jobUpdateParameter *models.JobUpdateParameter) {
	o.JobUpdateParameter = jobUpdateParameter
}
...
func (o *JobUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.JobUpdateParameter == nil {
		o.JobUpdateParameter = new(models.JobUpdateParameter)
	}

	if err := r.SetBodyParam(o.JobUpdateParameter); err != nil {
		return err
	}
