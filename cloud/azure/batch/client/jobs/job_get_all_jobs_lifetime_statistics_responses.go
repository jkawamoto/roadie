...
func (o *JobGetAllJobsLifetimeStatisticsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewJobGetAllJobsLifetimeStatisticsOK()
	...
	default:
		result := NewJobGetAllJobsLifetimeStatisticsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewJobGetAllJobsLifetimeStatisticsOK() *JobGetAllJobsLifetimeStatisticsOK {
	return &JobGetAllJobsLifetimeStatisticsOK{}
}
...
func (o *JobGetAllJobsLifetimeStatisticsOK) Error() string {
	return fmt.Sprintf("[GET /lifetimejobstats][%d] jobGetAllJobsLifetimeStatisticsOK  %+v", 200, o.Payload)
}

func (o *JobGetAllJobsLifetimeStatisticsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewJobGetAllJobsLifetimeStatisticsDefault(code int) *JobGetAllJobsLifetimeStatisticsDefault {
	return &JobGetAllJobsLifetimeStatisticsDefault{
		_statusCode: code,
	}
}
...
func (o *JobGetAllJobsLifetimeStatisticsDefault) Code() int {
	return o._statusCode
}

func (o *JobGetAllJobsLifetimeStatisticsDefault) Error() string {
	return fmt.Sprintf("[GET /lifetimejobstats][%d] Job_GetAllJobsLifetimeStatistics default  %+v", o._statusCode, o.Payload)
}

func (o *JobGetAllJobsLifetimeStatisticsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
