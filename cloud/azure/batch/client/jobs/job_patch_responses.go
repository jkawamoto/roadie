...
func (o *JobPatchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewJobPatchDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *JobPatchOK) Error() string {
	return fmt.Sprintf("[PATCH /jobs/{jobId}][%d] jobPatchOK ", 200)
}

func (o *JobPatchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *JobPatchDefault) Error() string {
	return fmt.Sprintf("[PATCH /jobs/{jobId}][%d] Job_Patch default  %+v", o._statusCode, o.Payload)
}

func (o *JobPatchDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
