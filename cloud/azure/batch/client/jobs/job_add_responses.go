...
func (o *JobAddReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewJobAddDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *JobAddCreated) Error() string {
	return fmt.Sprintf("[POST /jobs][%d] jobAddCreated ", 201)
}

func (o *JobAddCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *JobAddDefault) Error() string {
	return fmt.Sprintf("[POST /jobs][%d] Job_Add default  %+v", o._statusCode, o.Payload)
}

func (o *JobAddDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
