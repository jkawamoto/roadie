...
func (o *JobListFromJobScheduleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewJobListFromJobScheduleOK()
	...
	default:
		result := NewJobListFromJobScheduleDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewJobListFromJobScheduleOK() *JobListFromJobScheduleOK {
	return &JobListFromJobScheduleOK{}
}
...
func (o *JobListFromJobScheduleOK) Error() string {
	return fmt.Sprintf("[GET /jobschedules/{jobScheduleId}/jobs][%d] jobListFromJobScheduleOK  %+v", 200, o.Payload)
}

func (o *JobListFromJobScheduleOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewJobListFromJobScheduleDefault(code int) *JobListFromJobScheduleDefault {
	return &JobListFromJobScheduleDefault{
		_statusCode: code,
	}
}
...
func (o *JobListFromJobScheduleDefault) Code() int {
	return o._statusCode
}

func (o *JobListFromJobScheduleDefault) Error() string {
	return fmt.Sprintf("[GET /jobschedules/{jobScheduleId}/jobs][%d] Job_ListFromJobSchedule default  %+v", o._statusCode, o.Payload)
}

func (o *JobListFromJobScheduleDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
