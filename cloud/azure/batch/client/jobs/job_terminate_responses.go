...
func (o *JobTerminateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 202:
		result := NewJobTerminateAccepted()
	...
	default:
		result := NewJobTerminateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *JobTerminateAccepted) Error() string {
	return fmt.Sprintf("[POST /jobs/{jobId}/terminate][%d] jobTerminateAccepted ", 202)
}

func (o *JobTerminateAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *JobTerminateDefault) Error() string {
	return fmt.Sprintf("[POST /jobs/{jobId}/terminate][%d] Job_Terminate default  %+v", o._statusCode, o.Payload)
}

func (o *JobTerminateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
