...
func (o *PoolDisableAutoScaleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPoolDisableAutoScaleOK()
	...
	default:
		result := NewPoolDisableAutoScaleDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PoolDisableAutoScaleOK) Error() string {
	return fmt.Sprintf("[POST /pools/{poolId}/disableautoscale][%d] poolDisableAutoScaleOK ", 200)
}

func (o *PoolDisableAutoScaleOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPoolDisableAutoScaleDefault(code int) *PoolDisableAutoScaleDefault {
	return &PoolDisableAutoScaleDefault{
		_statusCode: code,
	}
}
...
func (o *PoolDisableAutoScaleDefault) Error() string {
	return fmt.Sprintf("[POST /pools/{poolId}/disableautoscale][%d] Pool_DisableAutoScale default  %+v", o._statusCode, o.Payload)
}

func (o *PoolDisableAutoScaleDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
