...
func (o *PoolGetAllPoolsLifetimeStatisticsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPoolGetAllPoolsLifetimeStatisticsOK()
	...
	default:
		result := NewPoolGetAllPoolsLifetimeStatisticsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPoolGetAllPoolsLifetimeStatisticsOK() *PoolGetAllPoolsLifetimeStatisticsOK {
	return &PoolGetAllPoolsLifetimeStatisticsOK{}
}
...
func (o *PoolGetAllPoolsLifetimeStatisticsOK) Error() string {
	return fmt.Sprintf("[GET /lifetimepoolstats][%d] poolGetAllPoolsLifetimeStatisticsOK  %+v", 200, o.Payload)
}

func (o *PoolGetAllPoolsLifetimeStatisticsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.PoolStatistics)
...
func NewPoolGetAllPoolsLifetimeStatisticsDefault(code int) *PoolGetAllPoolsLifetimeStatisticsDefault {
	return &PoolGetAllPoolsLifetimeStatisticsDefault{
		_statusCode: code,
	}
}
...
func (o *PoolGetAllPoolsLifetimeStatisticsDefault) Code() int {
	return o._statusCode
}

func (o *PoolGetAllPoolsLifetimeStatisticsDefault) Error() string {
	return fmt.Sprintf("[GET /lifetimepoolstats][%d] Pool_GetAllPoolsLifetimeStatistics default  %+v", o._statusCode, o.Payload)
}

func (o *PoolGetAllPoolsLifetimeStatisticsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
