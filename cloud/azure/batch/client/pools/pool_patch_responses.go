...
func (o *PoolPatchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewPoolPatchDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PoolPatchOK) Error() string {
	return fmt.Sprintf("[PATCH /pools/{poolId}][%d] poolPatchOK ", 200)
}

func (o *PoolPatchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *PoolPatchDefault) Error() string {
	return fmt.Sprintf("[PATCH /pools/{poolId}][%d] Pool_Patch default  %+v", o._statusCode, o.Payload)
}

func (o *PoolPatchDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
