...
func (o *PoolGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewPoolGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PoolGetOK) Error() string {
	return fmt.Sprintf("[GET /pools/{poolId}][%d] poolGetOK  %+v", 200, o.Payload)
}

func (o *PoolGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.CloudPool)
...
func (o *PoolGetDefault) Error() string {
	return fmt.Sprintf("[GET /pools/{poolId}][%d] Pool_Get default  %+v", o._statusCode, o.Payload)
}

func (o *PoolGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
