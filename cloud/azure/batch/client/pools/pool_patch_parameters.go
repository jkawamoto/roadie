...
// NewPoolPatchParams creates a new PoolPatchParams object
...
// NewPoolPatchParamsWithTimeout creates a new PoolPatchParams object
...
// NewPoolPatchParamsWithContext creates a new PoolPatchParams object
...
/*PoolPatchParams contains all the parameters to send to the API endpoint
for the pool patch operation typically these are written to a http.Request
*/
...
func (o *PoolPatchParams) WithPoolPatchParameter(poolPatchParameter *models.PoolPatchParameter) *PoolPatchParams {
	o.SetPoolPatchParameter(poolPatchParameter)
	return o
}
...
func (o *PoolPatchParams) SetPoolPatchParameter(poolPatchParameter *models.PoolPatchParameter) {
	o.PoolPatchParameter = poolPatchParameter
}
...
func (o *PoolPatchParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.PoolPatchParameter == nil {
		o.PoolPatchParameter = new(models.PoolPatchParameter)
	}

	if err := r.SetBodyParam(o.PoolPatchParameter); err != nil {
		return err
	}
