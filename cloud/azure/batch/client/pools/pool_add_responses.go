...
func (o *PoolAddReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewPoolAddDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PoolAddCreated) Error() string {
	return fmt.Sprintf("[POST /pools][%d] poolAddCreated ", 201)
}

func (o *PoolAddCreated) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *PoolAddDefault) Error() string {
	return fmt.Sprintf("[POST /pools][%d] Pool_Add default  %+v", o._statusCode, o.Payload)
}

func (o *PoolAddDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
