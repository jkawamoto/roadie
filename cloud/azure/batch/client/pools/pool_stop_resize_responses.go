...
func (o *PoolStopResizeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 202:
		result := NewPoolStopResizeAccepted()
	...
	default:
		result := NewPoolStopResizeDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PoolStopResizeAccepted) Error() string {
	return fmt.Sprintf("[POST /pools/{poolId}/stopresize][%d] poolStopResizeAccepted ", 202)
}

func (o *PoolStopResizeAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *PoolStopResizeDefault) Error() string {
	return fmt.Sprintf("[POST /pools/{poolId}/stopresize][%d] Pool_StopResize default  %+v", o._statusCode, o.Payload)
}

func (o *PoolStopResizeDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
