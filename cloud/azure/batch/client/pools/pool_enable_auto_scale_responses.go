...
func (o *PoolEnableAutoScaleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPoolEnableAutoScaleOK()
	...
	default:
		result := NewPoolEnableAutoScaleDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PoolEnableAutoScaleOK) Error() string {
	return fmt.Sprintf("[POST /pools/{poolId}/enableautoscale][%d] poolEnableAutoScaleOK ", 200)
}

func (o *PoolEnableAutoScaleOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPoolEnableAutoScaleDefault(code int) *PoolEnableAutoScaleDefault {
	return &PoolEnableAutoScaleDefault{
		_statusCode: code,
	}
}
...
func (o *PoolEnableAutoScaleDefault) Error() string {
	return fmt.Sprintf("[POST /pools/{poolId}/enableautoscale][%d] Pool_EnableAutoScale default  %+v", o._statusCode, o.Payload)
}

func (o *PoolEnableAutoScaleDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
