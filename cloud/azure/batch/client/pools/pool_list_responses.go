...
func (o *PoolListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewPoolListDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PoolListOK) Error() string {
	return fmt.Sprintf("[GET /pools][%d] poolListOK  %+v", 200, o.Payload)
}

func (o *PoolListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.CloudPoolListResult)
...
func (o *PoolListDefault) Error() string {
	return fmt.Sprintf("[GET /pools][%d] Pool_List default  %+v", o._statusCode, o.Payload)
}

func (o *PoolListDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
