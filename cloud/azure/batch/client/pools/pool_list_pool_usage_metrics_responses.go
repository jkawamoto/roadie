...
func (o *PoolListPoolUsageMetricsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPoolListPoolUsageMetricsOK()
	...
	default:
		result := NewPoolListPoolUsageMetricsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewPoolListPoolUsageMetricsOK() *PoolListPoolUsageMetricsOK {
	return &PoolListPoolUsageMetricsOK{}
}
...
func (o *PoolListPoolUsageMetricsOK) Error() string {
	return fmt.Sprintf("[GET /poolusagemetrics][%d] poolListPoolUsageMetricsOK  %+v", 200, o.Payload)
}

func (o *PoolListPoolUsageMetricsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.PoolListPoolUsageMetricsResult)
...
func NewPoolListPoolUsageMetricsDefault(code int) *PoolListPoolUsageMetricsDefault {
	return &PoolListPoolUsageMetricsDefault{
		_statusCode: code,
	}
}
...
func (o *PoolListPoolUsageMetricsDefault) Code() int {
	return o._statusCode
}

func (o *PoolListPoolUsageMetricsDefault) Error() string {
	return fmt.Sprintf("[GET /poolusagemetrics][%d] Pool_ListPoolUsageMetrics default  %+v", o._statusCode, o.Payload)
}

func (o *PoolListPoolUsageMetricsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
