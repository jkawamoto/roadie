...
func (o *PoolResizeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewPoolResizeDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PoolResizeAccepted) Error() string {
	return fmt.Sprintf("[POST /pools/{poolId}/resize][%d] poolResizeAccepted ", 202)
}

func (o *PoolResizeAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *PoolResizeDefault) Error() string {
	return fmt.Sprintf("[POST /pools/{poolId}/resize][%d] Pool_Resize default  %+v", o._statusCode, o.Payload)
}

func (o *PoolResizeDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
