...
func (o *PoolExistsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewPoolExistsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *PoolExistsOK) Error() string {
	return fmt.Sprintf("[HEAD /pools/{poolId}][%d] poolExistsOK ", 200)
}

func (o *PoolExistsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *PoolExistsNotFound) Error() string {
	return fmt.Sprintf("[HEAD /pools/{poolId}][%d] poolExistsNotFound ", 404)
}

func (o *PoolExistsNotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *PoolExistsDefault) Error() string {
	return fmt.Sprintf("[HEAD /pools/{poolId}][%d] Pool_Exists default  %+v", o._statusCode, o.Payload)
}

func (o *PoolExistsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
