...
func (o *CertificateDeleteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewCertificateDeleteDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewCertificateDeleteAccepted() *CertificateDeleteAccepted {
	return &CertificateDeleteAccepted{}
}
...
func (o *CertificateDeleteAccepted) Error() string {
	return fmt.Sprintf("[DELETE /certificates(thumbprintAlgorithm={thumbprintAlgorithm},thumbprint={thumbprint})][%d] certificateDeleteAccepted ", 202)
}

func (o *CertificateDeleteAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCertificateDeleteDefault(code int) *CertificateDeleteDefault {
	return &CertificateDeleteDefault{
		_statusCode: code,
	}
}
...
func (o *CertificateDeleteDefault) Error() string {
	return fmt.Sprintf("[DELETE /certificates(thumbprintAlgorithm={thumbprintAlgorithm},thumbprint={thumbprint})][%d] Certificate_Delete default  %+v", o._statusCode, o.Payload)
}

func (o *CertificateDeleteDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
