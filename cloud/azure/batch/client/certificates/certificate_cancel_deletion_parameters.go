...
// NewCertificateCancelDeletionParams creates a new CertificateCancelDeletionParams object
...
func NewCertificateCancelDeletionParams() *CertificateCancelDeletionParams {
	...
	return &CertificateCancelDeletionParams{
...
// NewCertificateCancelDeletionParamsWithTimeout creates a new CertificateCancelDeletionParams object
...
// NewCertificateCancelDeletionParamsWithContext creates a new CertificateCancelDeletionParams object
...
/*CertificateCancelDeletionParams contains all the parameters to send to the API endpoint
for the certificate cancel deletion operation typically these are written to a http.Request
*/
...
func (o *CertificateCancelDeletionParams) WithRequestTimeout(timeout time.Duration) *CertificateCancelDeletionParams {
...
func (o *CertificateCancelDeletionParams) WithContext(ctx context.Context) *CertificateCancelDeletionParams {
	o.SetContext(ctx)
	return o
}
...
func (o *CertificateCancelDeletionParams) WithAPIVersion(aPIVersion string) *CertificateCancelDeletionParams {
...
func (o *CertificateCancelDeletionParams) WithOcpDate(ocpDate *string) *CertificateCancelDeletionParams {
...
func (o *CertificateCancelDeletionParams) WithThumbprint(thumbprint string) *CertificateCancelDeletionParams {
...
func (o *CertificateCancelDeletionParams) WithTimeout(timeout *int32) *CertificateCancelDeletionParams {
...
func (o *CertificateCancelDeletionParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
