...
// NewComputeNodeDeleteUserParams creates a new ComputeNodeDeleteUserParams object
...
func NewComputeNodeDeleteUserParams() *ComputeNodeDeleteUserParams {
	...
	return &ComputeNodeDeleteUserParams{
...
// NewComputeNodeDeleteUserParamsWithTimeout creates a new ComputeNodeDeleteUserParams object
...
// NewComputeNodeDeleteUserParamsWithContext creates a new ComputeNodeDeleteUserParams object
...
/*ComputeNodeDeleteUserParams contains all the parameters to send to the API endpoint
for the compute node delete user operation typically these are written to a http.Request
*/
