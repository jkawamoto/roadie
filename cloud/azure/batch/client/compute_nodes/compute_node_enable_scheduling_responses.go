...
func (o *ComputeNodeEnableSchedulingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewComputeNodeEnableSchedulingOK()
	...
	default:
		result := NewComputeNodeEnableSchedulingDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewComputeNodeEnableSchedulingOK() *ComputeNodeEnableSchedulingOK {
	return &ComputeNodeEnableSchedulingOK{}
}
...
func (o *ComputeNodeEnableSchedulingOK) Error() string {
	return fmt.Sprintf("[POST /pools/{poolId}/nodes/{nodeId}/enablescheduling][%d] computeNodeEnableSchedulingOK ", 200)
}

func (o *ComputeNodeEnableSchedulingOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewComputeNodeEnableSchedulingDefault(code int) *ComputeNodeEnableSchedulingDefault {
	return &ComputeNodeEnableSchedulingDefault{
		_statusCode: code,
	}
}
...
func (o *ComputeNodeEnableSchedulingDefault) Error() string {
	return fmt.Sprintf("[POST /pools/{poolId}/nodes/{nodeId}/enablescheduling][%d] ComputeNode_EnableScheduling default  %+v", o._statusCode, o.Payload)
}

func (o *ComputeNodeEnableSchedulingDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
