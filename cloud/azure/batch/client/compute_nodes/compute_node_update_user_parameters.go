...
// NewComputeNodeUpdateUserParams creates a new ComputeNodeUpdateUserParams object
...
func NewComputeNodeUpdateUserParams() *ComputeNodeUpdateUserParams {
	...
	return &ComputeNodeUpdateUserParams{
...
// NewComputeNodeUpdateUserParamsWithTimeout creates a new ComputeNodeUpdateUserParams object
...
// NewComputeNodeUpdateUserParamsWithContext creates a new ComputeNodeUpdateUserParams object
...
/*ComputeNodeUpdateUserParams contains all the parameters to send to the API endpoint
for the compute node update user operation typically these are written to a http.Request
*/
...
func (o *ComputeNodeUpdateUserParams) WithNodeUpdateUserParameter(nodeUpdateUserParameter *models.NodeUpdateUserParameter) *ComputeNodeUpdateUserParams {
	o.SetNodeUpdateUserParameter(nodeUpdateUserParameter)
	return o
}
...
func (o *ComputeNodeUpdateUserParams) SetNodeUpdateUserParameter(nodeUpdateUserParameter *models.NodeUpdateUserParameter) {
	o.NodeUpdateUserParameter = nodeUpdateUserParameter
}
...
func (o *ComputeNodeUpdateUserParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.NodeUpdateUserParameter == nil {
		o.NodeUpdateUserParameter = new(models.NodeUpdateUserParameter)
	}

	if err := r.SetBodyParam(o.NodeUpdateUserParameter); err != nil {
		return err
	}
