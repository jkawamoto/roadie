...
// NewComputeNodeRebootParams creates a new ComputeNodeRebootParams object
...
func NewComputeNodeRebootParams() *ComputeNodeRebootParams {
	...
	return &ComputeNodeRebootParams{
...
// NewComputeNodeRebootParamsWithTimeout creates a new ComputeNodeRebootParams object
...
// NewComputeNodeRebootParamsWithContext creates a new ComputeNodeRebootParams object
...
/*ComputeNodeRebootParams contains all the parameters to send to the API endpoint
for the compute node reboot operation typically these are written to a http.Request
*/
...
func (o *ComputeNodeRebootParams) WithNodeRebootParameter(nodeRebootParameter *models.NodeRebootParameter) *ComputeNodeRebootParams {
	o.SetNodeRebootParameter(nodeRebootParameter)
	return o
}
...
func (o *ComputeNodeRebootParams) SetNodeRebootParameter(nodeRebootParameter *models.NodeRebootParameter) {
	o.NodeRebootParameter = nodeRebootParameter
}
...
func (o *ComputeNodeRebootParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.NodeRebootParameter == nil {
		o.NodeRebootParameter = new(models.NodeRebootParameter)
	}

	if err := r.SetBodyParam(o.NodeRebootParameter); err != nil {
		return err
	}
