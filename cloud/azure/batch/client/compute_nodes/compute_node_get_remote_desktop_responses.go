...
func (o *ComputeNodeGetRemoteDesktopReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewComputeNodeGetRemoteDesktopOK()
	...
	default:
		result := NewComputeNodeGetRemoteDesktopDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewComputeNodeGetRemoteDesktopOK() *ComputeNodeGetRemoteDesktopOK {
	return &ComputeNodeGetRemoteDesktopOK{}
}
...
func (o *ComputeNodeGetRemoteDesktopOK) Error() string {
	return fmt.Sprintf("[GET /pools/{poolId}/nodes/{nodeId}/rdp][%d] computeNodeGetRemoteDesktopOK  %+v", 200, o.Payload)
}

func (o *ComputeNodeGetRemoteDesktopOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewComputeNodeGetRemoteDesktopDefault(code int) *ComputeNodeGetRemoteDesktopDefault {
	return &ComputeNodeGetRemoteDesktopDefault{
		_statusCode: code,
	}
}
...
func (o *ComputeNodeGetRemoteDesktopDefault) Error() string {
	return fmt.Sprintf("[GET /pools/{poolId}/nodes/{nodeId}/rdp][%d] ComputeNode_GetRemoteDesktop default  %+v", o._statusCode, o.Payload)
}

func (o *ComputeNodeGetRemoteDesktopDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
