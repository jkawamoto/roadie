...
func (o *ComputeNodeGetRemoteLoginSettingsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewComputeNodeGetRemoteLoginSettingsOK()
	...
	default:
		result := NewComputeNodeGetRemoteLoginSettingsDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewComputeNodeGetRemoteLoginSettingsOK() *ComputeNodeGetRemoteLoginSettingsOK {
	return &ComputeNodeGetRemoteLoginSettingsOK{}
}
...
func (o *ComputeNodeGetRemoteLoginSettingsOK) Error() string {
	return fmt.Sprintf("[GET /pools/{poolId}/nodes/{nodeId}/remoteloginsettings][%d] computeNodeGetRemoteLoginSettingsOK  %+v", 200, o.Payload)
}

func (o *ComputeNodeGetRemoteLoginSettingsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ComputeNodeGetRemoteLoginSettingsResult)
...
func NewComputeNodeGetRemoteLoginSettingsDefault(code int) *ComputeNodeGetRemoteLoginSettingsDefault {
	return &ComputeNodeGetRemoteLoginSettingsDefault{
		_statusCode: code,
	}
}
...
func (o *ComputeNodeGetRemoteLoginSettingsDefault) Error() string {
	return fmt.Sprintf("[GET /pools/{poolId}/nodes/{nodeId}/remoteloginsettings][%d] ComputeNode_GetRemoteLoginSettings default  %+v", o._statusCode, o.Payload)
}

func (o *ComputeNodeGetRemoteLoginSettingsDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
