...
// NewComputeNodeGetRemoteDesktopParams creates a new ComputeNodeGetRemoteDesktopParams object
...
func NewComputeNodeGetRemoteDesktopParams() *ComputeNodeGetRemoteDesktopParams {
	...
	return &ComputeNodeGetRemoteDesktopParams{
...
// NewComputeNodeGetRemoteDesktopParamsWithTimeout creates a new ComputeNodeGetRemoteDesktopParams object
...
// NewComputeNodeGetRemoteDesktopParamsWithContext creates a new ComputeNodeGetRemoteDesktopParams object
...
/*ComputeNodeGetRemoteDesktopParams contains all the parameters to send to the API endpoint
for the compute node get remote desktop operation typically these are written to a http.Request
*/
