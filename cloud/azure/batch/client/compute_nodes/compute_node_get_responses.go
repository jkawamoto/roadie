...
func (o *ComputeNodeGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewComputeNodeGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *ComputeNodeGetOK) Error() string {
	return fmt.Sprintf("[GET /pools/{poolId}/nodes/{nodeId}][%d] computeNodeGetOK  %+v", 200, o.Payload)
}

func (o *ComputeNodeGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ComputeNode)
...
func (o *ComputeNodeGetDefault) Error() string {
	return fmt.Sprintf("[GET /pools/{poolId}/nodes/{nodeId}][%d] ComputeNode_Get default  %+v", o._statusCode, o.Payload)
}

func (o *ComputeNodeGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
