...
// NewTaskTerminateParams creates a new TaskTerminateParams object
...
// NewTaskTerminateParamsWithTimeout creates a new TaskTerminateParams object
...
// NewTaskTerminateParamsWithContext creates a new TaskTerminateParams object
...
/*TaskTerminateParams contains all the parameters to send to the API endpoint
for the task terminate operation typically these are written to a http.Request
*/
