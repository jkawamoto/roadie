...
func (o *TaskListSubtasksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewTaskListSubtasksDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
*/
type TaskListSubtasksOK struct {
	...
	Payload *models.CloudTaskListSubtasksResult
}

func (o *TaskListSubtasksOK) Error() string {
	return fmt.Sprintf("[GET /jobs/{jobId}/tasks/{taskId}/subtasksinfo][%d] taskListSubtasksOK  %+v", 200, o.Payload)
}

func (o *TaskListSubtasksOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.CloudTaskListSubtasksResult)
...
func NewTaskListSubtasksDefault(code int) *TaskListSubtasksDefault {
	return &TaskListSubtasksDefault{
		_statusCode: code,
	}
}
...
*/
type TaskListSubtasksDefault struct {
	_statusCode int
...
func (o *TaskListSubtasksDefault) Error() string {
	return fmt.Sprintf("[GET /jobs/{jobId}/tasks/{taskId}/subtasksinfo][%d] Task_ListSubtasks default  %+v", o._statusCode, o.Payload)
}

func (o *TaskListSubtasksDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
