...
// NewTaskGetParamsWithTimeout creates a new TaskGetParams object
...
// NewTaskGetParamsWithContext creates a new TaskGetParams object
...
/*TaskGetParams contains all the parameters to send to the API endpoint
for the task get operation typically these are written to a http.Request
*/
