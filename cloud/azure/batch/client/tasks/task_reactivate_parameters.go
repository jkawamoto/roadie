...
// NewTaskReactivateParams creates a new TaskReactivateParams object
...
// NewTaskReactivateParamsWithTimeout creates a new TaskReactivateParams object
...
// NewTaskReactivateParamsWithContext creates a new TaskReactivateParams object
...
/*TaskReactivateParams contains all the parameters to send to the API endpoint
for the task reactivate operation typically these are written to a http.Request
*/
