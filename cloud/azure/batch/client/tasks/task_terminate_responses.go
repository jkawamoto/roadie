...
func (o *TaskTerminateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewTaskTerminateNoContent()
	...
	default:
		result := NewTaskTerminateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
*/
type TaskTerminateNoContent struct {
...
func (o *TaskTerminateNoContent) Error() string {
	return fmt.Sprintf("[POST /jobs/{jobId}/tasks/{taskId}/terminate][%d] taskTerminateNoContent ", 204)
}

func (o *TaskTerminateNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
*/
type TaskTerminateDefault struct {
	_statusCode int
...
func (o *TaskTerminateDefault) Error() string {
	return fmt.Sprintf("[POST /jobs/{jobId}/tasks/{taskId}/terminate][%d] Task_Terminate default  %+v", o._statusCode, o.Payload)
}

func (o *TaskTerminateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
