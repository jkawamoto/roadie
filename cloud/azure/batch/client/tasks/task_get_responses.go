...
func (o *TaskGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewTaskGetDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
type TaskGetOK struct {
	...
	Payload *models.CloudTask
}

func (o *TaskGetOK) Error() string {
	return fmt.Sprintf("[GET /jobs/{jobId}/tasks/{taskId}][%d] taskGetOK  %+v", 200, o.Payload)
}

func (o *TaskGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.CloudTask)
...
func (o *TaskGetDefault) Error() string {
	return fmt.Sprintf("[GET /jobs/{jobId}/tasks/{taskId}][%d] Task_Get default  %+v", o._statusCode, o.Payload)
}

func (o *TaskGetDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
