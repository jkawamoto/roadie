...
func (o *TaskListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewTaskListDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
type TaskListOK struct {
	...
	Payload *models.CloudTaskListResult
}

func (o *TaskListOK) Error() string {
	return fmt.Sprintf("[GET /jobs/{jobId}/tasks][%d] taskListOK  %+v", 200, o.Payload)
}
...
func (o *TaskListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.CloudTaskListResult)
...
func (o *TaskListDefault) Error() string {
	return fmt.Sprintf("[GET /jobs/{jobId}/tasks][%d] Task_List default  %+v", o._statusCode, o.Payload)
}

func (o *TaskListDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
