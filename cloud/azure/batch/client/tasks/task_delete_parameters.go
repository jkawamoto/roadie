...
// NewTaskDeleteParamsWithTimeout creates a new TaskDeleteParams object
...
// NewTaskDeleteParamsWithContext creates a new TaskDeleteParams object
...
/*TaskDeleteParams contains all the parameters to send to the API endpoint
for the task delete operation typically these are written to a http.Request
*/
