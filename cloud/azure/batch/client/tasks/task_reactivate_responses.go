...
func (o *TaskReactivateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewTaskReactivateNoContent()
	...
	default:
		result := NewTaskReactivateDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewTaskReactivateNoContent() *TaskReactivateNoContent {
	return &TaskReactivateNoContent{}
}
...
*/
type TaskReactivateNoContent struct {
...
func (o *TaskReactivateNoContent) Error() string {
	return fmt.Sprintf("[POST /jobs/{jobId}/tasks/{taskId}/reactivate][%d] taskReactivateNoContent ", 204)
}

func (o *TaskReactivateNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
*/
type TaskReactivateDefault struct {
	_statusCode int
...
func (o *TaskReactivateDefault) Error() string {
	return fmt.Sprintf("[POST /jobs/{jobId}/tasks/{taskId}/reactivate][%d] Task_Reactivate default  %+v", o._statusCode, o.Payload)
}

func (o *TaskReactivateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
