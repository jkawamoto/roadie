...
// NewJobScheduleDisableParams creates a new JobScheduleDisableParams object
...
func NewJobScheduleDisableParams() *JobScheduleDisableParams {
	...
	return &JobScheduleDisableParams{
...
// NewJobScheduleDisableParamsWithTimeout creates a new JobScheduleDisableParams object
...
// NewJobScheduleDisableParamsWithContext creates a new JobScheduleDisableParams object
...
/*JobScheduleDisableParams contains all the parameters to send to the API endpoint
for the job schedule disable operation typically these are written to a http.Request
*/
...
func (o *JobScheduleDisableParams) WithContext(ctx context.Context) *JobScheduleDisableParams {
	o.SetContext(ctx)
	return o
}
