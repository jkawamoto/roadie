...
func (o *JobScheduleDisableReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 204:
		result := NewJobScheduleDisableNoContent()
	...
	default:
		result := NewJobScheduleDisableDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewJobScheduleDisableNoContent() *JobScheduleDisableNoContent {
	return &JobScheduleDisableNoContent{}
}
...
func (o *JobScheduleDisableNoContent) Error() string {
	return fmt.Sprintf("[POST /jobschedules/{jobScheduleId}/disable][%d] jobScheduleDisableNoContent ", 204)
}

func (o *JobScheduleDisableNoContent) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewJobScheduleDisableDefault(code int) *JobScheduleDisableDefault {
	return &JobScheduleDisableDefault{
		_statusCode: code,
	}
}
...
func (o *JobScheduleDisableDefault) Error() string {
	return fmt.Sprintf("[POST /jobschedules/{jobScheduleId}/disable][%d] JobSchedule_Disable default  %+v", o._statusCode, o.Payload)
}

func (o *JobScheduleDisableDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
