...
func (o *JobSchedulePatchReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewJobSchedulePatchDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *JobSchedulePatchOK) Error() string {
	return fmt.Sprintf("[PATCH /jobschedules/{jobScheduleId}][%d] jobSchedulePatchOK ", 200)
}

func (o *JobSchedulePatchOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewJobSchedulePatchDefault(code int) *JobSchedulePatchDefault {
	return &JobSchedulePatchDefault{
		_statusCode: code,
	}
}
...
func (o *JobSchedulePatchDefault) Error() string {
	return fmt.Sprintf("[PATCH /jobschedules/{jobScheduleId}][%d] JobSchedule_Patch default  %+v", o._statusCode, o.Payload)
}

func (o *JobSchedulePatchDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
