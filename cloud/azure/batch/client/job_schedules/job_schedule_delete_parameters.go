...
// NewJobScheduleDeleteParams creates a new JobScheduleDeleteParams object
...
func NewJobScheduleDeleteParams() *JobScheduleDeleteParams {
	...
	return &JobScheduleDeleteParams{
...
// NewJobScheduleDeleteParamsWithTimeout creates a new JobScheduleDeleteParams object
...
// NewJobScheduleDeleteParamsWithContext creates a new JobScheduleDeleteParams object
...
/*JobScheduleDeleteParams contains all the parameters to send to the API endpoint
for the job schedule delete operation typically these are written to a http.Request
*/
...
func (o *JobScheduleDeleteParams) WithContext(ctx context.Context) *JobScheduleDeleteParams {
	o.SetContext(ctx)
	return o
}
