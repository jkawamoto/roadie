...
func (o *JobScheduleListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		result := NewJobScheduleListDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func (o *JobScheduleListOK) Error() string {
	return fmt.Sprintf("[GET /jobschedules][%d] jobScheduleListOK  %+v", 200, o.Payload)
}

func (o *JobScheduleListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.CloudJobScheduleListResult)
...
func (o *JobScheduleListDefault) Error() string {
	return fmt.Sprintf("[GET /jobschedules][%d] JobSchedule_List default  %+v", o._statusCode, o.Payload)
}

func (o *JobScheduleListDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
