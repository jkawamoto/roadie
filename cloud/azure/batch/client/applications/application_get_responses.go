...
func (o *ApplicationGetOK) Error() string {
	return fmt.Sprintf("[GET /applications/{applicationId}][%d] applicationGetOK  %+v", 200, o.Payload)
}
...
func (o *ApplicationGetOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.ApplicationSummary)
...
func (o *ApplicationGetDefault) Error() string {
	return fmt.Sprintf("[GET /applications/{applicationId}][%d] Application_Get default  %+v", o._statusCode, o.Payload)
}
