...
func (a *Client) DeploymentOperationsGet(params *DeploymentOperationsGetParams, authInfo runtime.ClientAuthInfoWriter) (*DeploymentOperationsGetOK, error) {
	...
	if params == nil {
		params = NewDeploymentOperationsGetParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "DeploymentOperations_Get",
		Method:             "GET",
		PathPattern:        "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/deployments/{deploymentName}/operations/{operationId}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &DeploymentOperationsGetReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	return result.(*DeploymentOperationsGetOK), nil
...
func (a *Client) DeploymentOperationsList(params *DeploymentOperationsListParams, authInfo runtime.ClientAuthInfoWriter) (*DeploymentOperationsListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewDeploymentOperationsListParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "DeploymentOperations_List",
		Method:             "GET",
		PathPattern:        "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/deployments/{deploymentName}/operations",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &DeploymentOperationsListReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	...
	return result.(*DeploymentOperationsListOK), nil
