...
OK -- current usage acount and limit retrieved and returned successfully.
*/
type UsageListOK struct {
	Payload *models.UsageListResult
}

func (o *UsageListOK) Error() string {
	return fmt.Sprintf("[GET /subscriptions/{subscriptionId}/providers/Microsoft.Storage/usages][%d] usageListOK  %+v", 200, o.Payload)
}

func (o *UsageListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.UsageListResult)
