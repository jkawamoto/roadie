...
func (o *VirtualMachineImagesListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewVirtualMachineImagesListOK()
...
func NewVirtualMachineImagesListOK() *VirtualMachineImagesListOK {
	return &VirtualMachineImagesListOK{}
}
...
func (o *VirtualMachineImagesListOK) Error() string {
	return fmt.Sprintf("[GET /subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/publishers/{publisherName}/artifacttypes/vmimage/offers/{offer}/skus/{skus}/versions][%d] virtualMachineImagesListOK  %+v", 200, o.Payload)
}

func (o *VirtualMachineImagesListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
