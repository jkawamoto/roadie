...
func (o *VirtualMachineImagesListOffersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewVirtualMachineImagesListOffersOK()
...
func NewVirtualMachineImagesListOffersOK() *VirtualMachineImagesListOffersOK {
	return &VirtualMachineImagesListOffersOK{}
}
...
func (o *VirtualMachineImagesListOffersOK) Error() string {
	return fmt.Sprintf("[GET /subscriptions/{subscriptionId}/providers/Microsoft.Compute/locations/{location}/publishers/{publisherName}/artifacttypes/vmimage/offers][%d] virtualMachineImagesListOffersOK  %+v", 200, o.Payload)
}

func (o *VirtualMachineImagesListOffersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
