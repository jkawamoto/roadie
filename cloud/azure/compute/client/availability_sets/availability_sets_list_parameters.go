...
// NewAvailabilitySetsListParams creates a new AvailabilitySetsListParams object
// with the default values initialized.
func NewAvailabilitySetsListParams() *AvailabilitySetsListParams {
	var ()
	return &AvailabilitySetsListParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewAvailabilitySetsListParamsWithTimeout creates a new AvailabilitySetsListParams object
...
// NewAvailabilitySetsListParamsWithContext creates a new AvailabilitySetsListParams object
...
/*AvailabilitySetsListParams contains all the parameters to send to the API endpoint
for the availability sets list operation typically these are written to a http.Request
*/
...
func (o *AvailabilitySetsListParams) WithTimeout(timeout time.Duration) *AvailabilitySetsListParams {
...
func (o *AvailabilitySetsListParams) WithContext(ctx context.Context) *AvailabilitySetsListParams {
	o.SetContext(ctx)
	return o
}
