...
// swagger:model VirtualMachineInstanceView
...
func (m *VirtualMachineInstanceView) validateBootDiagnostics(formats strfmt.Registry) error {
...
func (m *VirtualMachineInstanceView) validateDisks(formats strfmt.Registry) error {
...
func (m *VirtualMachineInstanceView) validateExtensions(formats strfmt.Registry) error {
...
func (m *VirtualMachineInstanceView) validateStatuses(formats strfmt.Registry) error {
...
func (m *VirtualMachineInstanceView) validateVMAgent(formats strfmt.Registry) error {
