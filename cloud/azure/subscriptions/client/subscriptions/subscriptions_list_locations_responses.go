...
func (o *SubscriptionsListLocationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewSubscriptionsListLocationsOK()
...
func NewSubscriptionsListLocationsOK() *SubscriptionsListLocationsOK {
	return &SubscriptionsListLocationsOK{}
}
...
func (o *SubscriptionsListLocationsOK) Error() string {
	return fmt.Sprintf("[GET /subscriptions/{subscriptionId}/locations][%d] subscriptionsListLocationsOK  %+v", 200, o.Payload)
}

func (o *SubscriptionsListLocationsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.LocationListResult)
